        ...
        <div class="box-body">
            <form id="form" class="row">
                ...
                <div class="form-group col-md-4">
                    <label for="txtModelName" class="required">Model Name</label>
                ...
                <div class="form-group col-md-4">
                    ...
                    <select id="drdCommandType" class="select2 form-control select2-purple" style="width: 100%">
                ...
                <div class="form-group col-md-12">
                        <h3 style="font-size: 18px">Fields</h3>
                </div>
...
<section class="content">
    ...
    <div class="box box-primary col-lg-12">
        ...
        <div class="box-body">
            <form id="rollbackForm" class="row">
                <input type="hidden" name="_token" id="rbToken" value="{!! csrf_token() !!}" />

                <div class="form-group col-md-4">
                    <label for="txtRBModelName" class="required">Model Name</label>
                ...
                <div class="form-group col-md-4">
                    ...
                    <select id="drdRBCommandType" class="select2 form-control select2-purple" style="width: 100%">
...
<section class="content">
    ...
    <div class="box box-primary col-lg-12">
        ...
        <div class="box-body">
            <form method="post" id="schemaForm" class="row" enctype="multipart/form-data">
                <input type="hidden" name="_token" id="smToken" value="{!! csrf_token() !!}" />
                <div class="form-group col-md-4">
                    <label for="txtSmModelName" class="required">Model Name</label>
                    <input type="text" name="modelName" class="form-control" id="txtSmModelName" placeholder="Enter Model Name">
                </div>
                <div class="form-group col-md-4">
                    <label for="schemaFile" class="required">Schema File</label>
                    <input type="file" name="schemaFile" class="form-control" required id="schemaFile">
                </div>
                <div class="form-group col-md-4">
                    <label for="drdSmCommandType">Command Type</label>
                    <select name="commandType" id="drdSmCommandType" class="select2 form-control select2-purple" style="width: 100%">
                        <option value="infyom:api_scaffold">API Scaffold Generator</option>
                        <option value="infyom:api">API Generator</option>
                        <option value="infyom:scaffold">Scaffold Generator</option>
                    </select>
...
<script>
    ...
    $(function() {
        ...
        $(document).ready(function() {
            ...
            var commonComponent = $(htmlStr).filter("tr").load('{{ route("generator_builder.field_template") }}');
            var relationStr = '<tr class="relationItem" style="display: table-row;"></tr>';
            var relationComponent = $(relationStr).filter("tr").load('{{ route("generator_builder.relation_field_template") }}');
